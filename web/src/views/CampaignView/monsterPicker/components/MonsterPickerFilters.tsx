  ...
  return (
    <>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 6 }}>
        <Select value={props.sortMode} onChange={(e) => props.onChangeSortMode(e.target.value as SortMode)}>
          <option value="az">A-Z</option>
          <option value="crAsc">CR (low→high)</option>
          <option value="crDesc">CR (high→low)</option>
        </Select>

        <Select value={props.envFilter} onChange={(e) => props.onChangeEnvFilter(e.target.value)}>
