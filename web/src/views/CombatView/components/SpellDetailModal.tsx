  ...
  return (
    <Modal isOpen={props.isOpen} title={props.title} onClose={props.onClose} width={920} height={640}>
      <div style={{ padding: 14, height: "100%", overflow: "auto" }}>
        {props.isLoading ? (
          <div style={{ color: theme.colors.muted, fontWeight: 900, fontSize: 12 }}>Loading spell…</div>
        ) : null}

        {props.error ? (
          <div style={{ color: "#ff6b6b", fontSize: 12, fontWeight: 900 }}>{props.error}</div>
        ) : null}
        ...
        {props.spellDetail ? (
          ...
          >
            <div style={{ display: "flex", justifyContent: "space-between", gap: 10, alignItems: "center" }}>
              <div style={{ color: theme.colors.text, fontWeight: 900, fontSize: 12 }}>{props.spellDetail.name}</div>
            ...
            <div style={{ marginTop: 8, color: theme.colors.text, fontSize: 12, lineHeight: 1.35, whiteSpace: "pre-wrap" }}>
