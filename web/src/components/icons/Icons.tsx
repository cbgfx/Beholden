...
// Simple dragon head silhouette (monster icon)
export function IconDragon({ size = 32, title }: Props) {
  return (
    ...
    >
      {title ? <title>{title}</title> : null}
      <path d="M20.7 4.8c-1.6.1-3 .7-4 1.6-1.2-1-2.8-1.6-4.7-1.6-3.9 0-7 2.4-7 5.9 0 1.8.8 3.4 2.2 4.5-.1.5-.2 1-.2 1.6 0 2.2 1.2 4 3.3 4.9.4.2.9 0 1-.4l.4-1.6c.1-.5.6-.8 1.1-.7 1.4.3 2.7.3 4-.2 1.9-.7 3.3-2.2 3.9-4.1.1-.4 0-.8-.4-1l-1.5-.8 1.8-1.2c.3-.2.4-.6.2-1l-1.1-2 1.6-.3c.5-.1.8-.6.6-1.1l-.8-2.3zM10.5 12.2c-.5 0-.9-.4-.9-.9s.4-.9.9-.9.9.4.9.9-.4.9-.9.9z" />
    </svg>
  );
}
