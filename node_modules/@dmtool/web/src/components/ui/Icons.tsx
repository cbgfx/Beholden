...
// Simple dragon head icon (for monsters)
export function IconDragon({ size = 32, title }: Props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
    ...
    >
      ...
      <path d="M20.9 7.4c-1.1-1.1-2.7-1.7-4.4-1.7h-1.1l.6-1.7-3.5 1.3c-.6.2-1.1.6-1.4 1.2l-.3.6-1.1-.7c-1.5-1-3.4-1.1-5-.3l2.1 2.1c.3.3.2.8-.2 1.0L3 11.0l2.8.6c.6.1 1.0.6 1.0 1.2v1.0c0 1.6.9 3.0 2.2 3.8l.9.6-.7 2.8 2.8-1.6c.8-.5 1.8-.6 2.7-.3l2.2.7-.6-2.3c-.3-1.0 0-2.1.8-2.8l1.3-1.3c1.0-1.0 1.6-2.4 1.6-3.9 0-1.2-.5-2.4-1.3-3.2z" />
      <path d="M14.2 10.2a1 1 0 1 0 0 2 1 1 0 0 0 0-2z" />
    </svg>
  );
}