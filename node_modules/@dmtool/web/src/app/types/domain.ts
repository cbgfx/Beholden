...
export type Combatant = { id: string; baseType: "player"|"monster"|"inpc"; baseId: string; name: string; label: string; friendly: boolean; color: string; hpCurrent: number|null; hpMax: number|null; ac: number|null; };
