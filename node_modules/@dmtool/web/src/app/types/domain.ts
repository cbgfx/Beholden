...
export type Combatant = { id: string; encounterId: string; baseType: "player"|"monster"|"inpc"; baseId: string; name: string; label: string; friendly: boolean; color: string; hpCurrent: number|null; hpMax: number|null; hpDetails?: string|null; ac: number|null; acDetails?: string|null; };
